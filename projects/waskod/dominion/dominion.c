...
// BUG: while drawntreasure > 2 old: while drawntreasure < 2
int adventurerEffect(int *drawntreasure, struct gameState *state, int *currentPlayer, int *temphand, int *z, int *cardDrawn)
{
...
// BUG: for loop goes 4 times instead of 3
...
// BUG: currentPlayer and handPos switched in the discardCard call
...
// BUG: number of actions +2 instead of +1
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  case adventurer:
    //======================================================================================================================================================================================================================================Adventurer Effect
    return adventurerEffect(&drawntreasure, state, &currentPlayer, &temphand, &z, &cardDrawn);
    /*
    while (drawntreasure < 2)
    {
      if (state->deckCount[currentPlayer] < 1)
